...
Input:
-------------------------------------------------------------------------------------------------------
Proficiency, Difficulty, Percent
...
input_column_names = ['Proficiency','Difficulty', 'Percent','Jump'] ;
...
trainTarget = trainData.drop(columns = ['Proficiency', 'Difficulty', 'Percent']);
testInput = testData.drop(columns = ['Jump']);
testTarget = testData.drop(columns = ['Proficiency', 'Difficulty', 'Percent']);
